        ...
        binding.tabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            override fun onTabSelected(tab: TabLayout.Tab?) {
                ...
                when (tab?.text) {
                    ...
                    "워셔찾기" -> transaction.replace(R.id.owner_frag, OwnerFindWasherFragment())
                        .commit()
                    "세차현황" -> transaction.replace(R.id.owner_frag, OrderStatusOwnerFragment())
                        .commit()
                    "관리현황" -> transaction.replace(R.id.owner_frag, OwnerManagementHistoryFragment())
                        .commit()
                }
            }
